...
export const UPGRADES: UpgradeDefinition[] = [
  { id: 'attackPower', name: '잿불 칼날', description: '공격력이 4 증가합니다.', maxStacks: 5, color: 0xe36a55 },
  { id: 'attackSpeed', name: '재빠른 손', description: '공격 간격이 6% 감소합니다.', maxStacks: 5, color: 0xf0a35b },
  { id: 'attackRange', name: '넓게 번지는 불꽃', description: '공격 범위와 부채꼴 각도가 절반만큼 증가합니다.', maxStacks: 4, color: 0xf4c86b },
  ...
  { id: 'dashCooldown', name: '짧아진 그림자', description: '대시 재사용 대기시간이 75ms 감소합니다.', maxStacks: 4, color: 0x8d86db },
  { id: 'dashDuration', name: '머무는 잔상', description: '대시와 무적 시간이 27.5ms 증가합니다.', maxStacks: 3, color: 0xad82d4 },
  { id: 'roomRecovery', name: '승리의 온기', description: '방 정리 시 생명 회복량이 4 증가합니다.', maxStacks: 4, color: 0x72bf8e },
  { id: 'criticalChance', name: '처형자의 표식', description: '치명타 확률이 5% 증가합니다.', maxStacks: 4, color: 0xd85f91 },
