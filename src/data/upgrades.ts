...
export const UPGRADES: UpgradeDefinition[] = [
  { id: 'attackPower', name: '잿불 칼날', description: '공격력이 5 증가합니다.', maxStacks: 5, color: 0xe36a55 },
  ...
  { id: 'dashDuration', name: '머무는 잔상', description: '대시와 무적 시간이 0.1초 증가합니다.', maxStacks: 3, color: 0xad82d4 },
