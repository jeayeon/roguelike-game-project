...
export const UPGRADES: UpgradeDefinition[] = [
  ...
  { id: 'dashCooldown', name: '짧아진 그림자', description: '대시 재사용 대기시간이 0.1초 감소합니다.', maxStacks: 4, color: 0x8d86db },
  { id: 'dashDuration', name: '머무는 잔상', description: '대시와 무적 시간이 0.05초 증가합니다.', maxStacks: 3, color: 0xad82d4 },
